...
if (taskList.length > 0) {
    ...
    // I realized that after loading from localstorage, our currentId needs 
    // to be reset otherwise, we will run into duplicate data-id values.
    // The Math line is generated by an AI coding agent. 
    // It works like this: 
    //   1) Math.max() will find the max of an array of numbers,
    //       but it needs an array of just those numbers.
    //   2) taskList.map() creates an array of just the task.ids... 
